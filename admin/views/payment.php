                    ...
                    <td>
                        ...
                        <?php else : ?>
                            ...
                            <span class="mshield-hint">
                                <?php esc_html_e( 'This provider has no way to ask for it on a single order. Orders that would have been asked for 3-D Secure go through as normal.', 'mighty-shield' ); ?>
                            </span>
                        <?php endif; ?>
                    </td>
