...
6. Configure email domain blocklist and address validation sensitivity under **Fraud Checks**
...
**Layer 2 — Classic Checkout Protections:** Rate limiting, velocity detection, email/address validation, and failed payment tracking on the actual checkout flow via WooCommerce hooks. These protect against fraud on the checkout form itself.
